...
from objetos.funciones import text_elemento, click_elemento, captura_time, comboBox, text_elemento_intro
from test.Login import loginValido
from objetos.Obj_home import vacantes
from objetos.crearVacante.vacanteIA.paso1_IA import crearVacante, IA, puesto, personas_SI, personas_NO, CantidadPersonas, \
    Sueldo, SueldoIA, SueldoIA2, bruto, empresa, involve, pais, estado, municipio, modalidad, siguiente
